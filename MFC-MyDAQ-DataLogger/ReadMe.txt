================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: MFC-MyDAQ-DataLogger-Projektübersicht
===============================================================================

Diese MFC-MyDAQ-DataLogger-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MFC-MyDAQ-DataLogger-Anwendung besteht.

MFC-MyDAQ-DataLogger.vcxproj
...
MFC-MyDAQ-DataLogger.vcxproj.filters
...
MFC-MyDAQ-DataLogger.h
    Dies ist die Hauptheaderdatei für die Anwendung.
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CMFCMyDAQDataLoggerApp-Anwendungsklasse.

MFC-MyDAQ-DataLogger.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CMFCMyDAQDataLoggerApp enthält.

MFC-MyDAQ-DataLogger.rc
...
res\MFC-MyDAQ-DataLogger.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei MFC-MyDAQ-DataLogger.rc enthalten.

res\MFCMyDAQDataLogger.rc2
...
MFC-MyDAQ-DataLoggerDlg.h, MFC-MyDAQ-DataLoggerDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CMFCMyDAQDataLoggerDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in MFC-MyDAQ-DataLogger.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MFC-MyDAQ-DataLogger.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
